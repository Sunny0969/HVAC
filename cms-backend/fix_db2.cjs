...
<div class="bg-blue-50 p-6 rounded-xl border border-blue-100 mb-8 not-prose">
  ...
  <p class="text-sm font-bold text-[#EE5B2C] border-t border-blue-200 pt-3 mt-2">Key Takeaway: A DBPR Class A or B license requires 4 years of experience, and startup costs range from $15k to $200k+ depending on scale.</p>
</div>
`;
