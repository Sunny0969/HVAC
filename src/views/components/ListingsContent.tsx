          ...
          <div className="flex-1 w-full order-2 lg:order-1">
            ...
            {filtered.length === 0 ? (
              <div className="bg-white rounded-2xl p-12 text-center shadow-sm border border-gray-100">
                <div className="w-16 h-16 bg-[#022B3A]/10 rounded-full flex items-center justify-center mx-auto mb-6">
                  <svg className="w-8 h-8 text-[#022B3A]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                </div>
                <p className="text-xl font-bold text-[#022B3A] mb-3">No Current Listings</p>
                <p className="text-gray-600 font-medium mb-6 max-w-md mx-auto">
                  No public opportunities currently match your criteria. Register confidentially to receive appropriate future opportunities after qualification.
                </p>
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  <button
                    ...
                    className="px-6 py-3 bg-gray-100 hover:bg-gray-200 text-[#022B3A] font-bold rounded-xl transition-colors"
                  >
                    Clear Filters
                  </button>
                  <a href="/contact-us" className="px-6 py-3 bg-[#EE5B2C] hover:bg-orange-600 text-white font-bold rounded-xl transition-colors">
