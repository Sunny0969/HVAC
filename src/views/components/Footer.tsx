    ...
    <footer className="bg-primary text-white pt-12 pb-24 md:pb-12 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4 mb-4">
              ...
              <div className="flex items-start">
                ...
                <div className="text-white/80 text-sm">
                  <span className="block font-bold text-white mb-0.5">Florida Office</span>
                  Serving Statewide Florida Operations
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <a href="mailto:info@kmfbusinessadvisor.com" className="text-white/80 text-sm hover:text-secondary transition-colors break-all">
                  info@kmfbusinessadvisor.com
                </a>
              </div>
              ...
              <div className="flex items-start">
                ...
                <a href="tel:+18005632384" className="text-white/80 text-sm hover:text-secondary transition-colors">
                  +1 (800) KMF-ADVISE
                </a>
              </div>
        ...
        <div className="pt-8 border-t border-white/20 flex flex-col md:flex-row justify-between items-center text-sm text-white/60">
          <p className="mb-4 md:mb-0">&copy; {new Date().getFullYear()} KMF Business Advisors. All rights reserved.</p>
