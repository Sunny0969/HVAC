    ...
    <main className="min-h-screen flex flex-col bg-[#F7F5F0]">
      ...
      <section className="relative w-full h-[100dvh] overflow-hidden bg-gray-900 text-white flex items-center justify-center">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="/Florida HVAC Business Worth.jpg"
            alt="Florida HVAC Business Worth"
            fill
            priority
            sizes="100vw"
            ...
            <div className="sticky top-32 bg-white rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100 p-8 max-h-[calc(100vh-10rem)] overflow-y-auto">
              ...
              <form className="flex flex-col space-y-4">
                ...
                <div>
                  ...
                  <input type="text" className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#EE5B2C] focus:border-transparent outline-none transition-all" placeholder="Optional" />
                </div>
                <div>
                  <label className="block text-sm font-bold text-[#022B3A] mb-1">How can we help?</label>
                  <textarea rows={4} className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#EE5B2C] focus:border-transparent outline-none transition-all resize-none" placeholder="E.g., I'm thinking of selling in the next 12-24 months..."></textarea>
                </div>
