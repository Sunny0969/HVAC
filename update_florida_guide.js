  ...
  return (
    <>
      ...
      <main className="w-full bg-[#F7F5F0] min-h-screen font-sans pb-24">
        ...
        {/* Hero Section */}
        <section className="relative w-full min-h-[500px] overflow-hidden bg-[#022B3A] text-white flex items-center justify-center pt-24 pb-16">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 text-center">
            ...
            <div className="bg-white/95 backdrop-blur-sm p-6 md:p-8 rounded-2xl shadow-xl border border-orange-200 mt-10 text-left text-gray-800 max-w-3xl mx-auto">
                ...
                <div className="overflow-x-auto mt-6">
                  <table className="w-full text-left border-collapse min-w-[700px]">
                    ...
                    <tbody className="divide-y divide-gray-200 border-b border-gray-200">
                      ...
                      <tr>
                        <td className="p-4 font-medium">Workers' Comp</td>
