const fs = require('fs');
let code = fs.readFileSync('src/views/components/MarketInsightsFAQ.tsx', 'binary');
// Just rewrite it fully via node with utf8
const correctCode = `
"use client";
...
fs.writeFileSync('src/views/components/MarketInsightsFAQ.tsx', correctCode, 'utf8');
