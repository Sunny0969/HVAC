...
fs.writeFileSync('src/views/components/FloatingWhatsAppButton.tsx', componentCode);
console.log("Created FloatingWhatsAppButton.tsx");

// Update layout.tsx
let layoutContent = fs.readFileSync('src/app/layout.tsx', 'utf8');

if (!layoutContent.includes('FloatingWhatsAppButton')) {
