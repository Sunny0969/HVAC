    ...
    <>
      ...
      <main className="w-full bg-[#F7F5F0] min-h-screen py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="lg:w-[65%] xl:w-[70%]">
              ...
              <article className="prose prose-lg max-w-none text-gray-800 bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-6">
                ...
                <h2 id="how-much-do-hvac-owners-make" className="text-2xl md:text-3xl font-bold text-[#022B3A] border-b pb-3 pt-8 scroll-mt-28">
                ...
                <h2 id="is-hvac-in-high-demand" className="text-2xl md:text-3xl font-bold text-[#022B3A] border-b pb-3 pt-8 scroll-mt-28">
                ...
                <h2 id="is-florida-a-good-place" className="text-2xl md:text-3xl font-bold text-[#022B3A] border-b pb-3 pt-8 scroll-mt-28">
                ...
                <h2 id="what-is-the-5000-rule" className="text-2xl md:text-3xl font-bold text-[#022B3A] border-b pb-3 pt-8 scroll-mt-28">
                ...
                <h2 id="how-to-open-hvac-business" className="text-2xl md:text-3xl font-bold text-[#022B3A] border-b pb-3 pt-8 scroll-mt-28">
                ...
                <h2 id="what-field-pays-most" className="text-2xl md:text-3xl font-bold text-[#022B3A] border-b pb-3 pt-8 scroll-mt-28">
          ...
          <div className="mt-20">
            <div className="bg-white rounded-[2rem] shadow-xl border border-gray-100 p-8 md:p-12 max-w-4xl mx-auto">
              <div className="text-center mb-8">
                <h2 className="text-3xl md:text-4xl font-black text-[#022B3A] mb-4">Have More Questions?</h2>
                <p className="text-lg text-gray-600 font-medium">Contact our Florida HVAC brokerage team today for a confidential consultation.</p>
              </div>
